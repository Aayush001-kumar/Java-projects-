...
- ✅ User account setup with a custom 4-digit PIN
- 🔐 PIN verification system (5 attempts max)
- 💰 Check current account balance
- 📥 Deposit money into the account
- 📤 Withdraw money from the account with input validation
- ❌ Cancel withdrawal and return to main menu
- 📛 Input validation for non-numeric values and invalid amounts
...
3. The main menu offers four options:
    ...
    - `3` → Withdraw Amount
    - `4` → Exit the program
4. Proper input validation ensures safe and user-friendly interaction
